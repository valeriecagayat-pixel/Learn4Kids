...
/**
 * Toggles the visibility of the sidebar menu and its dark overlay background.
 */
...
/**
 * Detects the current page based on the browser's URL path 
 * and applies an 'active' highlight style to the matching navbar link.
 */
...
/* ========================================================
   8. VOICE WORKSHOP LOGIC (Record & Playback)
   ======================================================== */
let mediaRecorders = {}; 
let audioChunksMap = {}; 
...
/* ========================================================
   9. READING MODULE LOGIC (Noun Hunt Sentences)
   ======================================================== */
const nounLevels = [
...
/* ========================================================
   10. WRITING MODULE (Canvas Trace Engine)
   ======================================================== */  
...
// Global drawing stroke tracking state map
let history = new Map();
...
/* ========================================================
   11. TEXT TO SPEECH AUDIO CONTROLLER
   ======================================================== */
...
/* ========================================================
   12. SECTION 3 - CHALLENGE MORE SCRAMBLE GAME LOGIC
   ======================================================== */
const challenges = [
...
/* ========================================================
   13. UNIFIED INITIALIZER (Context-aware mounting loader)
   ======================================================== */
...
/* ========================================================
   14. COMPONENT ACCORDIONS & INTERACTION HANDLERS
   ======================================================== */

/**
 * FAQ Accordion Panel Toggle Handler
 * Transitions FAQ containers open and shut smoothly using heights calculated via scrollHeight.
 */
 ...
 * Suppresses default refresh behavior to display child-friendly feedback notifications.
 */
...
/**
 * Context Back Button Navigation Handler
 * Instructs the engine window history to route back a step, fallbacking onto index pages.
 */
...
/* ========================================================
   15. PINOY HENYO AUDIO GAME LOGIC (FIXED SYNTAX)
   ======================================================== */

/**
 * Compares clicked button elements to confirm accuracy, turning valid items
 * green while highlighting exact corrections for broken targets.
 */
function checkHenyoAnswer(buttonElement) {
    ...
    if (isCorrect) {
        ...
        // Reveal correct answer to the player
...
/**
 * Captures inputs from student profile names and securely pushes records to sessionStorage.
 */
function saveUser() {
...
/**
 * Authentication check verification verifying session state data presence on load.
 */
